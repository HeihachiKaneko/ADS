...
public class InterfaceGrafica {
	...
	public void exibirMenu(Conta conta) {
		while(true) {
			...
			case 8:
				System.exit(0);
			default:
				JOptionPane.showMessageDialog(null, "Erro, tente uma opção válida", "Erro", JOptionPane.ERROR_MESSAGE);
				break;
			}
		}
	}
	...
	public void informacoesDeposito(Conta conta) {
		...
		while (valor < 10) {
			JOptionPane.showMessageDialog(null, "O valor depositado não pode ser menor que R$ 10.00", "Erro",
	...
	public void informacoesSaque(Conta conta) {
		...
		while (valor < 5) {
			JOptionPane.showMessageDialog(null, "O valor depositado não pode ser menor que R$ 5.00", "Erro",
					JOptionPane.ERROR_MESSAGE);
			valor = Float
					.parseFloat(JOptionPane.showInputDialog("Insira o valor que deseja sacar:"));
		}
